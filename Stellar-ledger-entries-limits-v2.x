...
//: `LimitsV2Entry` is used in system configuration to set limits (daily, weekly, montly, annual) for different assets, operations (according to StatsOpType) either globally (with no account role provided), or for account role, or for account.
