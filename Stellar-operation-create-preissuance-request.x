...
{
    //: Means that pre issuance request successfully created
    ...
    //: Only current pre issuer can do pre issuance
    INVALID_SIGNATURE = -4,
    ...
    //: Not allowed to create pre issuance request with zero amount
    ...
    //: configuration does not allow to pre issue asset with such code
...
{
case SUCCESS:
    //: Is used to pass useful fields of success operation applying
    struct
    {
