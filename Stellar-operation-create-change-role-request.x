...
//: CreateChangeRoleRequestOp is used to change role of `destinationAccount`
...
struct CreateChangeRoleRequestOp
{
    ...
    //: Documents based on which admin will approve request
...
enum CreateChangeRoleRequestResultCode
{
    ...
    //: Not allowed to change role which equal existing current role of `destinationAccount`
	ROLE_ID_IS_THE_SAME = -3,
