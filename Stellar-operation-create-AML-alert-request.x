...
//: that will void the specified amount from the target balance after the reviewer's approval.
...
enum CreateAMLAlertRequestResultCode
{
    ...
    SUCCESS = 0,
    //: Balance with the provided balance ID does not exist.
...
//: Result of `CreateAMLAlertRequest` operation successful application.
